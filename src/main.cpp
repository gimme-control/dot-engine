...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600 , "dot engine", nullptr, nullptr);
    ...
    Shader shaders("shaders/vertex_shader.glsl", "shaders/fragment_shader.glsl");
    ...
    unsigned char *data = stbi_load("assets/some.jpg", &width, &height , &nrChannels, 0);
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        for(int i = 0; i < 10; i++)
        {
            ...
            shaders.setMat4(modelLoc, model);
            glDrawArrays(GL_TRIANGLES, 0, 36); 
        }

        // check and call events and swap buffers 
        // two buffers to prevent screen tearing
